...
info: "なぜ、Haskellは美しいと言われるのか? - Netadashi Meetup #17"
...
<!--
- なぜ、Haskellは美しいと言われるのかというタイトルで発表します
- よろしく
-->
...
## やりたいこと: Haskellを流行らせたい!

<Callout type="warn" title="ポール・グレアム: Beating the Averages">

- 慣れ親しんだ言語をベースに考えるとそれより、機能が少ないことはわかる。
- 慣れ親しんだ言語よりもパワフルな言語を見ても、何がすごいのか分からない。
</Callout>

- 普通の言語をベースに考えるとHaskellの価値は伝わらない
- この発表でHaskellのパワフルな機能を認知できるようにする
